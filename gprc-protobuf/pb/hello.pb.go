...
var file_pb_hello_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x22, 0x27, 0x0a, 0x11, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x57, 0x6f, 0x72,
	...
	0x28, 0x09, 0x52, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x32, 0x44, 0x0a, 0x03, 0x52, 0x70, 0x63,
...
var file_pb_hello_proto_depIdxs = []int32{
	0, // 0: pb.Rpc.HelloWorld:input_type -> pb.HelloWorldRequest
	1, // 1: pb.Rpc.HelloWorld:output_type -> pb.HelloWorldResponse
...
func (c *rpcClient) HelloWorld(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.Rpc/HelloWorld", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedRpcServer) HelloWorld(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error) {
